  ...
  <div class="container-footer">
    <div class="text-white d-flex justify-content-between">
      ...
      <nav class="nav flex-column">
        ...
        <span class="text-muted"><i class="fas fa-phone"></i> +33 7 60 62 54 73</span>
      </nav>
      <nav class="nav flex-column d-none d-md-flex">
        <span class="pb-3">Email</span>
        <span class="text-muted"><i class="far fa-envelope"></i> christophe.sbastien@gmail.com</span>
      </nav>
      <nav class="nav flex-column">
        <span class="pb-3">Mes projets personnel</span>
    ...
    <div>
      <div class="d-flex justify-content-between">
        <div class="float-left text-muted pt-4">
          <p>design by Christophe Sébastien aka @PepseeActus</p>
        </div>
        <div class="reseaux float-right pt-4">
